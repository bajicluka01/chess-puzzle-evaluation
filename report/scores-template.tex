...
Table \ref{classification} displays the performance of the standard machine learning models on a dataset with 1000 samples and all available attributes. Class distribution is 39.1\% "easy", 38.9\% "medium" and 22.0\% "hard". 
