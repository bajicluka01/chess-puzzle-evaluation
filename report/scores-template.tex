...
\subsection{Case 1: tactical puzzles}

\subsection{Case 2: arbitrary positions}

When considering an arbitrary position, that is, a tactical or strategic one, the biggest limitation for model training is the lack of objective ground truth (although objectiveness and accuracy of tactical puzzle ELO can also be disputed). 
